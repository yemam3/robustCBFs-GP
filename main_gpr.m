...
disturb_estimator = DisturbanceEstimator(N,n,m,IS_SIM,CBF_SPECS.cbf_mode,COMM_MODE,IP,PORT);
...
while true 
    ...
    if mod(counter,100) == 1
        save(['saved_data/gpr_mqtt_workspace_', CBF_SPECS.cbf_mode, '_', date_string,'.mat']);
    end
    counter = counter + 1;
    pause(0.1)
end
